...
if (isset($_POST['send'])) {
    $subject = htmlspecialchars($_POST['subject']); // HTML escaping for security
    $message = htmlspecialchars($_POST['message']); // HTML escaping for security
...
<script>
        document.addEventListener('DOMContentLoaded', function () {
            // Your script for automatically filling in the message
