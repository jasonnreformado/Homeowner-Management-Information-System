...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "insert into tblcomplaint(FirstName,LastName,Phone,Email,address,subject,time,Message) value('$fname','$lname','$phone','$email','$address','$subject','$time','$message')");
    if ($query) {
